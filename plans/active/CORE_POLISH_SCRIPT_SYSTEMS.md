...
> **Статус: 🚧 в работе (старт 2026-07-06). Волна 0 ✅ ЗАКРЫТА** (0.1 A5-актуализация, 0.2
> ParallelPolicy::Fixed, 0.3 B5, 0.4 B6, 0.5 §1.4 — реализованы и закоммичены; 0.6 string-table —
> переоценён §0.2b, вынесен в отдельный focused-заход, остаётся 🟢 открыт). Далее — волна 1
> (детерминизм). Источник истины
...
решения в соразмерный заход, §0.2b).

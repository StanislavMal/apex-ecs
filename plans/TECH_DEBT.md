...
- **CMD-RECORD-0830 🟡 ОТКРЫТ — половина ЗАПИСИ в `Commands` стоит 2.85× эталона, и это ЕДИНСТВЕННОЕ
  ...
  **Не взято сознательно:** это переделка всех вариантов `Command`, всех мест их построения и
  диспетчера `apply` — полное решение уровня §0.2b, а не то, что дописывается хвостом захода.

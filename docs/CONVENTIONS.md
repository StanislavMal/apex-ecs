...
> **Статус:** живой документ · заведён 2026-07-05 (кампания `plans/active/API_GOLDEN_PATH.md`,
> волна 3, координация §8 Rule D).
>
...
4. `deprecated`-алиасы живут до следующего мажора; удаляются отдельным breaking-коммитом.
